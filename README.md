...
<!-- <div class="equation" align="center" data-raw-text="\cos(x) = \sum_{n=0}^{\infty} \frac{(-1)^n}{(2n)!} x^{2n} = 1 - \frac{x^2}{2!} + \frac{x^4}{4!} - \cdots" data-equation="eq:cosine_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/cosf/docs/img/equation_cosine_function.svg" alt="Cosine function Taylor series expansion">
    <br>
</div> -->
